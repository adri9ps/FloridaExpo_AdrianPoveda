    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnPerfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // REEMPLAZAMOS EL FRAMELAYOUT POR EL FRAGMENT DE PERFIL
                fm = getFragmentManager();
                ft = fm.beginTransaction();
                ft.replace(R.id.fmLayout,PerfilFragment.newInstance("",""));
                ft.commit();
        ...
        btnConfig.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // REEMPLAZAMOS EL FRAMELAYOUT POR EL FRAGMENT DE CONFIGURACIÓN
                fm = getFragmentManager();
                ft = fm.beginTransaction();
                ft.replace(R.id.fmLayout,ConfiguracionFragment.newInstance("",""));
                ft.commit();
        ...
        btnSalir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent salir = new Intent(getContext(), MainActivity.class);
                startActivity(salir);
